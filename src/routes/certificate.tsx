...
function CertificatePage() {
  ...
  const unlocked = isAllComplete(completed);
  ...
  return (
    <div className="mx-auto max-w-2xl pb-16">
      <header className="mb-6">
        ...
        <h1 className="mt-1 font-display text-2xl font-semibold text-fg">学习证明</h1>
      ...
      {!unlocked ? (
        <section className="rounded-xl border border-border bg-surface p-8 text-center">
          ...
          <p className="mt-4 text-sm text-muted">
            进度 {doneCount}/{LESSONS.length} · 继续学习即可解锁
          </p>
        ...
        <section className="relative overflow-hidden rounded-xl border border-primary/30 bg-surface p-8 text-center shadow-soft">
          ...
          <div className="relative">
            ...
            <p className="mx-auto mt-3 max-w-md text-sm leading-relaxed text-muted">
              兹证明持有人已完成本站全部课程：基础、进阶、官网对齐、全栈准备、全栈实训、工程化与进阶模式（含
              SFC 编辑器与模拟 API 工坊）。
            </p>
